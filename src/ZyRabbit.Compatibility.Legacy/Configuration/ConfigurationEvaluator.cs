...
namespace ZyRabbit.Compatibility.Legacy.Configuration
{
	...
	{
		private readonly ZyRabbitConfiguration _clientConfig;
		private readonly INamingConventions _conventions;
		private readonly string _directReplyTo = "amq.rabbitmq.reply-to";

		public ConfigurationEvaluator(ZyRabbitConfiguration clientConfig, INamingConventions conventions)
		{
