...
using ISubscription = ZyRabbit.Subscription.ISubscription;
...
namespace ZyRabbit.Pipe
{
	public static class PipeContextExtension
	{
		...
		public static ZyRabbitConfiguration GetClientConfiguration(this IPipeContext context)
		{
			return context.Get<ZyRabbitConfiguration>(PipeKey.ClientConfiguration);
		}
	}
}
