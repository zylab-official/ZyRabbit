...
using ExchangeType = ZyRabbit.Configuration.Exchange.ExchangeType;

namespace ZyRabbit.Configuration
{
	public class ZyRabbitConfiguration
	{
		/// <summary>
		...
		public static ZyRabbitConfiguration Local => new ZyRabbitConfiguration
		{
			VirtualHost = "/",
			Username = "guest",
			Password = "guest",
	...
	public class GeneralExchangeConfiguration
	{
		...
		/// <summary>
		/// There are four different types of exchanges see <see cref="ZyRabbit.Configuration.Exchange"/> for more info.
		/// </summary>
		public ExchangeType Type { get; set; }
	}

	public static class ZyRabbitConfigurationExtensions
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="config">The ZyRabbit configuration object</param>
		/// <returns></returns>
		public static ZyRabbitConfiguration AsHighPerformance(this ZyRabbitConfiguration config)
		{
